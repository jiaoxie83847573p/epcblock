...
class Floodgate
{
    class FloodRecord
    {
      public:
        ...
        FloodRecord(epcMessage const& msg, uint32_t ledger,
                    Peer::pointer peer);
    };
  ...
  public:
    ...
    bool addRecord(epcMessage const& msg, Peer::pointer fromPeer);

    void broadcast(epcMessage const& msg, bool force);
