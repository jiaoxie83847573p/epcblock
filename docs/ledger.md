...
- **Ledger**: A ledger is the state of the distributed epc database at a
...
- **Ledger header**: The ledger's header contains meta data about the ledger,
  ...
  own hash. (See [`src/xdr/epc-ledger.x`](/src/xdr/epc-ledger.x))


`epc-core` maintains the content of the latest ledger and of the ledger
...
performance needs.
 ...
 4. Finally, `epc-core` can be configured to upload detailed historical
