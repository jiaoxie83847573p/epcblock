...
Two slightly-obscurely-named components are:
  ...
  - SCP -- "epc Consensus Protocol", the component implementing the
    [consensus algorithm](https://www.epc.org/papers/epc-consensus-protocol.pdf).
...
- Set of core validator nodes. Running epc-core only. Tasked with:
...
- Set of public HTTP nodes. Not running epc-core. Running
...
- (optional): Set of public validator nodes. Running epc-core only. Tasked
with:
  ...
  - Basically just a epc-network load balancer / firewall for public access,
